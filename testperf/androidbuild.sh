...
if [ ${OPENH264_PERFTEST_ANDROID_PLATFORM} == simulator ]; then
	...
	adb push ${BASE_PATH}/../testbin/welsenc.cfg ${OPENH264_PERFTEST_ENCODER_WORKPATH_ON_DEVICE}
...
if [ ${OPENH264_PERFTEST_ANDROID_PLATFORM} == simulator ] ; then
	...
	adb logcat -c
	adb shell rm ${OPENH264_PERFTEST_DECODER_WORKPATH_ON_DEVICE}/${DEC_LOG_FILE_NAME}
